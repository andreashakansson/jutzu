    ...
    <app-layout title="Guide">
        ...
        <div class="py-10">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mb-2">
                ...
                <img class="mt-2" src="/img/guide/1.png" style="max-width:800px;"/>
                <p class="mt-4">4. Klicka i "Starta vid: x" för att få videon att starta där du
                    pausat:</p>
